...
export default function UserInfoView({ email, name, role, status = "ACTIVE", organizationName }: Props) {
  return (
    <div className="bg-gray-50 rounded-lg p-4 mb-6">
      ...
      <div className="space-y-2 text-sm">
        ...
        {organizationName && (
          <div className="flex justify-between"><span className="font-medium text-gray-700">Organization:</span><span className="text-gray-900">{organizationName}</span></div>
        )}
