      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
          </div>
          <div>
            <label
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder-gray-500 ${disableEmail ? "text-gray-400" : "text-gray-900"}`}
          />
        </div>
        {showRole && (
          <div>
          ...
          <>
            ...
            <div className="flex justify-end">
              <button
                ...
                className={`px-4 py-2 rounded-xl text-sm font-medium text-white ${changingPassword ? "bg-gray-400 cursor-not-allowed" : "bg-gray-900 hover:bg-gray-800 focus:ring-2 focus:ring-gray-300"}`}
              >
