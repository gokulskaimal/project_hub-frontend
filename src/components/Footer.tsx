          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
            <div className="flex-1">
              <div className="mb-3 flex items-center gap-2">
                ...
                <span className="text-base font-semibold text-gray-900">Project Hub</span>
              </div>
              <p className="max-w-md text-sm text-gray-600">
                Project management that helps teams plan, track, and collaborate effortlessly.
              </p>
            </div>
            <div className="flex flex-wrap gap-6 lg:gap-8">
              ...
              <a className="text-sm text-gray-600 hover:text-gray-900" href="#">Get Started</a>
            </div>
          </div>
          <div className="mt-8 border-t border-gray-200 pt-6">
            <p className="text-center text-xs text-gray-500">© 2025 Project Hub. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
