      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-8 py-6 border-b border-gray-100 bg-gray-50/50">
          ...
          <div className="flex items-center justify-between relative max-w-sm mx-auto">
            ...
            <div
              className="absolute top-1/2 left-0 h-0.5 bg-blue-600 -z-10 -translate-y-1/2 rounded transition-all duration-300"
            ...
            {[1, 2, 3].map((num) => (
              <div key={num} className={`flex flex-col items-center gap-2`}>
                ...
                <span
                  className={`text-xs font-medium ${step >= num ? "text-blue-600" : "text-gray-400"}`}
                >
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3 flex-wrap">
                  {formData.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 bg-blue-50 text-blue-700 rounded-lg text-xs font-medium flex items-center gap-1 group"
                    >
                      {tag}
                      <button
          ...
          {step === 3 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300 h-full flex flex-col">
              ...
              <p className="text-sm text-gray-500 font-medium">
                Select members needed for this project
              </p>
