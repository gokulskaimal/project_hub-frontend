                ...
                <div className="grid lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        <div className="space-y-6">
                            {[
                                { name: 'Onboarding', depends: 'Depends on Design', progress: 80, color: 'bg-[#2463EB]/60' },
                                { name: 'Design', depends: 'Depends on Research', progress: 60, color: 'bg-[#7750E2]/60' },
                                { name: 'API & backend', depends: 'Depends on Design', progress: 40, color: 'bg-[#2463EB]/50' },
                                { name: 'Web app', depends: 'Depends on API', progress: 90, color: 'bg-[#2463EB]/40' },
                            ].map((item, index) => (
