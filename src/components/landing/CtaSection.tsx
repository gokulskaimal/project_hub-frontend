    ...
    <section id="cta" className="py-20 bg-gradient-to-b from-transparent to-[#2463EB]/5">
        <div className="container max-w-[1400px] mx-auto px-8 text-center">
            ...
            <div className="flex items-center justify-center gap-3">
                <Link href="/signup" className="rounded-lg bg-[#2463EB] px-8 py-3 text-white font-medium hover:bg-[#2463EB]/90">Sign Up Free</Link>
                <Link href="#" className="rounded-lg border border-gray-300 bg-white px-8 py-3 text-gray-900 font-medium hover:bg-gray-50">Request Demo</Link>
            </div>
        </div>
    </section> 
);
