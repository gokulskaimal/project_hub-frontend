...
export default function CtaSection() {
  return (
    <section
      id="cta"
      className="py-20 bg-gradient-to-b from-transparent to-[#2463EB]/5"
    >
      <div className="container max-w-[1400px] mx-auto px-8 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto mb-8">
          Sign up free to get started in minutes.
        </p>
        <div className="flex items-center justify-center gap-3">
          <Link
            href="/signup"
            className="rounded-xl bg-[#2463EB] px-8 py-3 text-white font-medium hover:bg-[#2463EB]/90"
          >
            Sign Up Free
          </Link>
          <Link
