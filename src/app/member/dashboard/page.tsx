          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 space-y-3">
            {projects.slice(0, 3).map((project) => (
              <Link
                ...
                className="block p-3 rounded-lg border border-gray-100 hover:border-blue-200 hover:bg-blue-50/30 transition-all group"
              >
                <div className="flex justify-between items-start mb-2">
                  <h4 className="text-sm font-bold text-gray-900 group-hover:text-blue-700 truncate">
                    {project.name}
                  </h4>
                  <span
