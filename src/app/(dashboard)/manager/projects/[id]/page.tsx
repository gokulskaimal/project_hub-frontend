...
import { Pencil, Trash2, ArrowLeft, Calendar, User as UserIcon, CheckCircle2, Search, LayoutGrid, List, Plus, Clock, AlertCircle } from "lucide-react";
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900">{project?.name || 'Loading Project...'}</h1>
                    ...
                    <p className="text-gray-500 text-sm max-w-2xl ml-9">{project?.description}</p>
                </div>
                ...
                <div className="lg:col-span-3 space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                            <p className="text-gray-500 text-xs font-medium uppercase tracking-wider">Total Tasks</p>
                        ...
                        <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                            ...
                            <div className="flex items-end justify-between mt-2">
                                <h3 className="text-2xl font-bold text-orange-600">{tasks.filter(t => t.status === 'TODO' || t.status === 'IN_PROGRESS').length}</h3>
                         ...
                         <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                            <p className="text-gray-500 text-xs font-medium uppercase tracking-wider">Critical</p>
                             <div className="flex items-end justify-between mt-2">
                                <h3 className="text-2xl font-bold text-red-600">{tasks.filter(t => t.priority === 'CRITICAL' && t.status !== 'DONE').length}</h3>
