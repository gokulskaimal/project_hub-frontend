...
import { ArrowLeft, LayoutList, KanbanSquare, Users, Settings } from "lucide-react";
...
export default function ProjectLayout({
  ...
  const tabs = [
    { name: "Overview", href: `/manager/projects/${projectId}`, icon: LayoutList, exact: true },
    { name: "Board", href: `/manager/projects/${projectId}/board`, icon: KanbanSquare, exact: false },
    // Future tabs:
